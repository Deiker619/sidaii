            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="08-desarrolloSocial-asignar.php?id=<?php echo $registros["id"]?>">Asignar actividad</a></td>
                        <td><a href="eliminar/eliminar_solicitud.php?id=<?php echo $registros["id"]?>" class="eliminar">Eliminar Reg</a></td>
                    </tr>
                    <?php
                    }
                        }
