    ...
    <div class="tabla-atencion">
        ...
        <table>
            ...
            <tbody>
                ...
                $aten = new remitido(1);
                $consulta = $aten->consultarTodosRemitidosDesarrollo();
                ...
                ?>
                        <tr>
                            ...
                            <td><a href="--aceptar_desarrollo.php?cedula=<?php echo  $registros["cedula"]; ?>" class="remitir" id="aceptar">Aceptar reg</a></td>
                            <td><a href="" class="eliminar" id="rechazar">Rechazar reg</a></td>
