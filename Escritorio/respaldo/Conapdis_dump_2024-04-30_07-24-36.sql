...
INSERT INTO `atenciones` VALUES (357,8261209,'2024-04-23','Andadera','26-Anpf','-ayudatec','Atendido',30165406,'2024-04-23 13:55:33',NULL,NULL,NULL),(358,8999541,'2024-04-30','Regleta con punzon','6-andadera','-ayudatec','Atendido',30165406,'2024-04-25 13:37:26','urgente',NULL,NULL),(362,54545454,NULL,'Silla sanitaria sin ruedas',NULL,NULL,'En espera',NULL,'2024-04-28 20:55:05','urgente',NULL,'66301e019a304.pdf'),(363,54545454,NULL,'Muletas talla M',NULL,NULL,'En espera',NULL,'2024-04-29 19:19:58','media',NULL,NULL);
...
INSERT INTO `detalles_institucionales` VALUES (241,8261209,'no',NULL),(243,45787874,'no',NULL),(244,54878785,'no',NULL),(246,25454456,'no',NULL),(247,45454545,'no',NULL),(248,8999541,'no',NULL),(249,65465656,'no',NULL),(250,54545454,'no',NULL),(251,301654061,'no',NULL);
...
INSERT INTO `direcciones` VALUES (27,'asa',8261209),(29,'rtert',45787874),(30,'rtert',54878785),(32,'44',25454456),(33,'asda',45454545),(34,'545',8999541),(35,'0',65465656),(36,'iko',54545454),(37,'asdasd',301654061);
...
CREATE TABLE `familiaresoac` (
  ...
  CONSTRAINT `familiaresoac_ibfk_1` FOREIGN KEY (`id_atencion`) REFERENCES `atenciones` (`numero_aten`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `modificaciones_beneficiarios` VALUES (1,'484986','Pablito Gonzalez','Fernandez','2024-02-20 20:10:00'),(2,'30165406','Jose','Fernández','2024-03-21 15:47:56'),(3,'8999541','jose reinaldo','torres berrios','2024-04-16 15:20:28'),(4,'8261209','soraima','torres','2024-04-16 15:20:57'),(5,'8261209','soraima','torres','2024-04-16 15:21:27'),(6,'301654061','Camila ','lopez','2024-04-25 13:03:36'),(7,'301654061','Camila ','lopez','2024-04-25 15:40:38'),(8,'301654061','Camila ','lopez','2024-04-25 15:41:07'),(9,'301654061','Camila ','lopez','2024-04-25 15:41:27'),(10,'301654061','Camila ','lopez','2024-04-25 15:41:50'),(11,'301654061','Camila ','lopez','2024-04-25 15:41:58'),(12,'301654061','Camila ','lopez','2024-04-25 15:42:10'),(13,'54545454','Felix Key','dfaaa','2024-04-29 19:19:25'),(14,'54545454','Felix Key','dfaaa','2024-04-29 19:57:49');
...
-- Dump completed on 2024-04-30  7:24:40
