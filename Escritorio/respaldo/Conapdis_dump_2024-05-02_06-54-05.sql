...
CREATE TABLE `atenciones` (
  ...
  CONSTRAINT `atenciones_ibfk_5` FOREIGN KEY (`familiar`) REFERENCES `familiaresoac` (`id`) ON DELETE CASCADE
...
INSERT INTO `atenciones` VALUES (357,8261209,'2024-04-23','Andadera','26-Anpf','-ayudatec','Atendido',30165406,'2024-04-23 13:55:33',NULL,NULL,NULL,NULL),(358,8999541,'2024-05-02','Regleta con punzon','2-MuletasL','-ayudatec','Atendido',30165406,'2024-04-25 13:37:26','urgente',NULL,NULL,NULL);
...
INSERT INTO `porcentajes` VALUES ('2023-07-27',15.2),('2023-07-28',2.9),('2023-07-30',0),('2023-07-31',0),('2023-08-02',0),('2023-08-05',3.7),('2023-08-06',0),('2023-08-07',0),('2023-08-09',0),('0000-00-00',100),('August',100),('September',85.7),('October',23.5),('November',11.1),('December',0),('January',20),('February',100),('March',0),('April',100),('May',0);
...
-- Dump completed on 2024-05-02  6:54:07
