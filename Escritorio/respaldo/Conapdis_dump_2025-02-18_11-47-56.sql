...
INSERT INTO `detalles_institucionales` VALUES (277,28484435,'no',NULL);
...
INSERT INTO `direcciones` VALUES (63,'petare',28484435);
...
CREATE TABLE `discapacid_e` (
  ...
  `id_e` varchar(10) CHARACTER SET latin1 NOT NULL,
  `general` varchar(10) CHARACTER SET latin1 NOT NULL,
  PRIMARY KEY (`id_e`),
  KEY `general` (`general`),
...
CREATE TABLE `historia_medica` (
  ...
  `cedula` int(12) NOT NULL,
  `artificio` varchar(10) CHARACTER SET latin1 NOT NULL,
...
INSERT INTO `informes_medicos` VALUES (1,30165406,'Deiker Jose',NULL),(2,28484435,'Gerardo',NULL);
...
INSERT INTO `jornada` VALUES (110,'11','129','417',2,'4Gtno','C-miran','2025-02-12 13:16:00'),(111,'1','1','1',1,'2Atc',NULL,'2025-02-12 13:16:00'),(112,'24','462','1117',2,'4Gtno','C-amaz','2025-02-12 13:16:00'),(113,'19','363','872',21,'4Gtno','C-tach','2025-02-12 13:16:00'),(114,'19','363','871',15,'4Gtno','C-tach','2025-02-12 13:16:00');
...
) ENGINE=InnoDB AUTO_INCREMENT=519420467 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `porcentajes` VALUES ('2023-07-27',15.2),('2023-07-28',2.9),('2023-07-30',0),('2023-07-31',0),('2023-08-02',0),('2023-08-05',3.7),('2023-08-06',0),('2023-08-07',0),('2023-08-09',0),('0000-00-00',100),('August',100),('September',85.7),('October',0),('November',100),('December',100),('January',66.7),('February',78.6),('March',0),('April',100),('May',9.1);
...
-- Dump completed on 2025-02-18 11:48:00
