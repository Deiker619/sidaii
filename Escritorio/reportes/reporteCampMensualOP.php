...
<body>
    ...
    $mes = $_REQUEST["mes"];
    $anio = $_REQUEST["anio"];
    $consulta = $aten->campamentos_mensual($mes, $anio);
    ...
    <div class="dash-contenido">
        ...
        <div class="cont-registro">
            <div class="container">
                ...
                <h3 style="margin-top: 20px;">Reporte mensual: <?php echo $nombreMes . " " . $anio; ?></h3>
    ...
    $nombre = "ReporteCampamentosMensual" . date("Y-m-d H:i:s");
