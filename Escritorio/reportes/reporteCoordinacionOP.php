...
<body>
    ...
    /* echo $numero_aten; */
    $consulta = $aten->atencionesDadas_COORDINACION();
                    ...
                    <table style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th>Cantidad de artificios entregados en total</th>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($consulta as $registros) { ?>
                                <tr>
                                    <td><?php echo $registros["nombre_coordinacion"]; ?> </td>
                                    <td><?php echo $registros["Recibidas"]; ?> </td>
                                </tr>
                            <?php } ?>
                    ...
                    <table style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th>Cantidad del artificio entregado por la coordinacion</th>
                        ...
                        <tbody>
                            ...
                            <?php
                            $consulta = $aten->atencionesDadas_COORDINACIONxAYUDATECNICA();
                            foreach ($consulta as $registros) { ?>
                                <tr>
                                    <td><?php echo $registros["nombre_coordinacion"]; ?> </td>
                                    <td><?php echo $registros["Recibidas"]; ?> </td>
                                    <td><?php echo $registros["CantidadRecibidas"]; ?> </td>
                                </tr>
                            <?php } ?>
