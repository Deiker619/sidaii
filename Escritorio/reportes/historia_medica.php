                    ...
                    <div class="tabla-atencion" style="width: 100%;">
                        ...
                        <table style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $consulta["artificio"] ?> </td>
                                </tr>
                        ...
                        <table style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $consulta["artificio_medidas"] ?> </td>
                                    <td><?php echo $consulta["diseño"] ?> </td>
                                    <td><?php echo $consulta["lado_afectado"] ?> </td>
                                </tr>
                        ...
                        <table style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $consulta["zona_del_lado"] ?> </td>
                                    <td><?php echo $consulta["nervio"] ?> </td>
                                    <td><?php echo $consulta["solicitud"] ?> </td>
                                </tr>
                        ...
                        <table style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Fecha para la cita de medidas</th>
                                    <th>Tecnico</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $consulta["fecha_apertura"] ?> </td>
                                    <td><?php echo $consulta["fecha_medidas"] ?> </td>
                                    <td>Persona</td>
