...
<body>
    ...
    $consulta = $aten->campamentos_semanal();
                    ...
                    <table style="width:100%">
                        ...
                        <tbody>
                            <?php foreach ($consulta as $registros) { ?>
                                <tr>
                                    <td><?php echo $registros["semana"]; ?></td>
                                    <td><?php echo $registros["inicio_semana"]; ?></td>
    ...
    $nombre = "ReporteCampamentosSemanal" . date("Y-m-d H:i:s");
