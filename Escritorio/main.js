...
const chart3 = document.querySelector("#bar-chart").getContext("2d");
...
const chart10 = document.querySelector("#graficaspordiscapacidadg").getContext("2d");
...
function cargarGraficaXdiscapacidad() {
  $.ajax({
    type: "POST",
    url: "graficasPorDiscapacidadE.php",
    dataType: "json",
