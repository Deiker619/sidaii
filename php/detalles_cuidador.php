...
class detalles_cuidador extends ManejadorBD{
        /* ================================== */
        private $cedula;
        private $id;
        private $fecha_cita;
        ...
        public function getcedula_r()
        {
            return $this->cedula_r ;
        }
		public function setcedula_r($cedula_r)
		{
		...
		public function insertardetalles(){
			try{	
				...
				$stmt = $this->cnn->prepare("INSERT INTO detalles_cuidador (cedula, nombre, cedula_r) 
				VALUES (:cedula, :nombre, :cedula_r )");
				
				// Asignamos valores a los parametros
				$stmt->bindParam(':cedula', $this->cedula);
				$stmt->bindParam(':nombre', $this->nombre);
				$stmt->bindParam(':cedula_r', $this->cedula_r);
